...
export function queryElements() {
  return {
    ...
    sessionChipLabel: document.querySelector('#session-chip-label'),
    sessionChipDot: document.querySelector('#session-chip-dot'),
    ...
    externalHintDismiss: document.querySelector('#external-hint-dismiss'),
    ...
    newSessionFlow: document.querySelector('#new-session-flow'),
    newSessionStart: document.querySelector('#new-session-start'),
    showAgents: document.querySelector('#show-agents'),
    showAllSessions: document.querySelector('#show-all-sessions'),
